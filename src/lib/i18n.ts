...
const dictionaries = {
  en: {
    ...
    descTransitionShort: "{t1} and {t2} day, {time}",
    descTransitionTooEarly: "{t1} and {t2} day, the window is too early",
    descTransitionTooLate: "{t1} and {t2} day, the window is too late",
    ...
    noTimeRestriction: "enjoy anytime",
    tooEarly: "early to enjoy",
    tooLate: "late at night",
    ctxMostOfDay: "good most of the day",
    ctxMorning: "morning window",
    ctxUntilMidday: "good until midday",
    ctxMiddayAfternoon: "midday to afternoon",
    ctxAfternoon: "afternoon window",
    ctxAfternoonEvening: "afternoon into evening",
    ctxUntilEvening: "good until the evening",
    ctxEvening: "evening window",
    ctxAtNight: "late, only at night",
    todayLower: "today",
  ...
  es: {
    ...
    descTransitionShort: "Día de {t1} y {t2}, {time}",
    descTransitionTooEarly: "Día de {t1} y {t2}, la ventana es demasiado temprana",
    descTransitionTooLate: "Día de {t1} y {t2}, la ventana es demasiado tarde",
    descTransitionNoWindow: "Día de {t1} y {t2}, los aromas no se expresan hoy",

    bestMoment: "Mejor momento",
    noWindow: "Sin ventana",
    notRecommended: "no recomendado",
    noTimeRestriction: "disfruta cuando quieras",
    tooEarly: "demasiado temprano",
    tooLate: "demasiado tarde",
    ctxMostOfDay: "bueno casi todo el día",
    ctxMorning: "ventana por la mañana",
    ctxUntilMidday: "bueno hasta el mediodía",
    ctxMiddayAfternoon: "mediodía a tarde",
    ctxAfternoon: "ventana por la tarde",
    ctxAfternoonEvening: "tarde y noche",
    ctxUntilEvening: "bueno hasta la noche",
    ctxEvening: "ventana por la noche",
    ctxAtNight: "tarde, solo de noche",
    todayLower: "hoy",
